<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            @if (!isset(Auth::user()->name))
            <div class="-mx-3 sm:flex flex-1 justify-end hidden sm:visible">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
            ...
            @if (Route::has('login'))
                @auth
                    <div class="px-4">
                        <div class="font-medium text-base text-gray-800 dark:text-gray-200">{{ isset(Auth::user()->name) ? Auth::user()->name : '' }}</div>
                        <div class="font-medium text-sm text-gray-500">{{ isset(Auth::user()->email) ? Auth::user()->email : ''
                        }}</div>
                    </div>
